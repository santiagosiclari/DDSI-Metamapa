...
async function crearHecho(e) {
    ...
    try {
        ...
        // === Enviar al backend ===
        const resp = await fetch(`${window.METAMAPA.API_FUENTES_DINAMICA}/${data.fuenteId}/hechos`,
...
async function actualizarHechos() {
    try {
        ...
        if (resp.ok) {
            ...
            mostrarModal("Hechos actualizados desde las fuentes.", "✅ Actualización completa");
